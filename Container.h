...
/**
*
*   Stable Index Vector (SIV) by John Buffer [MIT] (Pezzza's Work on Youtube)
*   youtube.com/watch?v=L4xOCvELWlU
*   github.com/johnBuffer/StableIndexVector
*
*   This utility has been renamed from "Vector" to "Container" and added to the "Violet" namespace.
*
*/
...
namespace Violet
{
    ...
    /** A standalone struct allowing to access an object without the need to have a reference to the containing Container.
     *
    ...
    private:
        ...
        Container<TObjectType>* m_vector = nullptr;

        /// Used to perform debug checks
        friend class Container<TObjectType>;
    };
    ...
    public:
        ...
        [[nodiscard]]
        bool isValidID(Violet::ID id) const
        {
